...
<div class="main-header">
    ...
    <p>Tác giả: Bùi Thị Văn - Trường  Tiểu học Hùng An - ĐT: 0917402432</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bùi Thị Văn - Trường Tiểu học Hùng An - ĐT: 0917402432</div>", unsafe_allow_html=True)
